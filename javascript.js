...
// -------------------
	$(".add-item").on('click', function(event) {
      ...
      console.log(listItem);//need to add something here
		  var itemHtml = "<li><span class='item-check'></span><span class='item-text'>" + listItem + "</span><span class='item-remove'></span></li>";
      $('.shopping-list').append(itemHtml);// Add the itemHtml section we created for you above to the shopping-list
      $('.item-input').val('');// Remove the text the user entered from item-input
	});
// -------------------
